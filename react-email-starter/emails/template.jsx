...
export default function EmailTemplate({
            ...
            <Html>
                ...
                <Body style={styles.body}>
                    <Container style={styles.container}>
                        ...
                        {data?.insights && (
                            <Section style={styles.section}>
                                <Heading style={styles.heading}>Flowoid AI Insights</Heading>
                        ...
                        <Text style={styles.footer}>
                            Thank you for using Flowoid. Keep tracking your finances for better
                            financial health!
                        </Text>
                    </Container>
                </Body>
    ...
    if (type === "budget-alert") {
        const percentageUsed = data?.percentageUsed ? Number(data.percentageUsed).toFixed(1) : "0";
            ...
            <Html>
                ...
                <Body style={styles.body}>
                    <Container style={styles.container}>
                        ...
                        <Text style={styles.text}>Hello {userName},</Text>
                        <Text style={styles.text}>
                            You&rsquo;ve used {percentageUsed}% of your
                            monthly budget.
                        </Text>
                        <Section style={styles.statsContainer}>
                            <div style={styles.stat}>
